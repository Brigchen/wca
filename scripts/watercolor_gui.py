...
from PyQt5.QtGui import QImage, QPixmap, QFont, QCursor, QMouseEvent
...
class ImageColorAnalyzer(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowTitle('WCA: GUI for Water Color Analyzing')
        # self.showMaximized()
